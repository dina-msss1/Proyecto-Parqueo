...
class SaldoCajero: # Se creo una clase para la ventana Saldo del cajero
    def __init__(self, master):
        ...
        self.label_entradas_cantidad_monedast1.config(text=cajero[conf[5]])
        self.label_entradas_cantidad_monedast2.config(text=cajero[conf[6]])
        self.label_entradas_cantidad_monedast3.config(text=cajero[conf[7]])
        self.label_entradas_cantidad_total_monedas.config(text=cajero[conf[5]]+cajero[conf[6]]+cajero[conf[7]])
        self.label_entradas_cantidad_billetest1.config(text=cajero[conf[8]])
        self.label_entradas_cantidad_billetest2.config(text=cajero[conf[9]])
        self.label_entradas_cantidad_billetest3.config(text=cajero[conf[10]])
        self.label_entradas_cantidad_billetest4.config(text=cajero[conf[11]])
        self.label_entradas_cantidad_billetest5.config(text=cajero[conf[12]])
        self.label_entradas_cantidad_total_billetes.config(text=cajero[conf[8]]+cajero[conf[9]]+cajero[conf[10]]+cajero[conf[11]]+cajero[conf[12]])
        ...
        self.label_entradas_total_monedast1.config(text=cajero[conf[5]]*int(conf[5]))
        self.label_entradas_total_monedast2.config(text=cajero[conf[6]]*int(conf[6]))
        self.label_entradas_total_monedast3.config(text=cajero[conf[7]]*int(conf[7]))
        self.label_entradas_total_total_monedas.config(text=cajero[conf[5]]*int(conf[5])+cajero[conf[6]]*int(conf[6])+cajero[conf[7]]*int(conf[7]))
        self.label_entradas_total_billetest1.config(text=cajero[conf[8]]*int(conf[8]))
        self.label_entradas_total_billetest2.config(text=cajero[conf[9]]*int(conf[9]))
